...
from results_txt.read_step import read_step
...
plt.plot(t2, y2, color='blue', linestyle='dashed', label="Salida (V) (valores normalizados)")
plt.plot(t3, y3, color='blue', label="Salida (V) (LTspice)")
